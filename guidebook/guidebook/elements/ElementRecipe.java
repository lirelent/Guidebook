...
import com.lireherz.guidebook.guidebook.recipe.RecipeProvider;
...
public class ElementRecipe extends Element {
	...
	public int reflow (List<VisualElement> list, IBookGraphics nav, Rect bounds, Rect pageBounds) {
		...
		if (recipeProvider != null && (recipeKey != null || recipeOutput instanceof ElementStack)) {
			components = recipeKey != null ? retrieveRecipe(recipeProvider, recipeKey) : retrieveRecipe(recipeProvider, (ElementStack) recipeOutput);
		}
	...
	public void parse (IConditionSource book, NamedNodeMap attributes) {
		...
		if (attr != null) {
			...
			if (recipeIndexObj != null) {
				recipeIndex = recipeIndexObj;
			}
		}
	}
